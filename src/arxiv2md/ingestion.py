...
def _populate_section_markdown(
    section, *, remove_inline_citations: bool = False, base_url: str | None = None
) -> None:
    if section.html:
        section.markdown, section.footnotes = convert_fragment_to_markdown(
            section.html,
            remove_inline_citations=remove_inline_citations,
            base_url=base_url,
        )
    for child in section.children:
        _populate_section_markdown(
            child, remove_inline_citations=remove_inline_citations, base_url=base_url
        )
